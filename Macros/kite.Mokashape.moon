...
apply_auto = (subs, sel, prepared, opts) ->
...
build_interface = (input, script_res) ->
  ...
  {
    main: {
      input_label: {class: "label", label: "Adobe After Effects Mask Data:", x: 0, y: 0, width: 14, height: 1}
      input: {class: "textbox", value: input or "", config: false, x: 0, y: 1, width: 14, height: 9}

      output_label: {class: "label", label: "Output:", x: 0, y: 10, width: 2, height: 1}
      output_mode: {class: "dropdown", items: OUTPUT_MODES, value: DEFAULTS.output_mode, config: true, x: 2, y: 10, width: 3, height: 1}
      placement_label: {class: "label", label: "Placement:", x: 5, y: 10, width: 2, height: 1}
      placement: {class: "dropdown", items: PLACEMENTS, value: DEFAULTS.placement, config: true, x: 7, y: 10, width: 5, height: 1}

      fps_label: {class: "label", label: "FPS:", x: 0, y: 11, width: 1, height: 1}
      fps: {class: "floatedit", value: meta.fps, config: true, min: 1, x: 1, y: 11, width: 3, height: 1}

      use_source_meta: {class: "checkbox", label: "Use AE source size", value: DEFAULTS.use_source_meta, config: true, x: 5, y: 11, width: 5, height: 1}
      scale_to_script: {class: "checkbox", label: "Scale to script", value: DEFAULTS.scale_to_script, config: true, x: 10, y: 11, width: 4, height: 1}

      source_w_label: {class: "label", label: "Source W/H:", x: 0, y: 12, width: 3, height: 1}
      source_width: {class: "intedit", value: meta.source_width, config: true, min: 1, x: 3, y: 12, width: 3, height: 1}
      source_height: {class: "intedit", value: meta.source_height, config: true, min: 1, x: 6, y: 12, width: 3, height: 1}
      target_w_label: {class: "label", label: "Target W/H:", x: 0, y: 13, width: 3, height: 1}
      target_width: {class: "intedit", value: script_res.x, config: true, min: 1, x: 3, y: 13, width: 3, height: 1}
      target_height: {class: "intedit", value: script_res.y, config: true, min: 1, x: 6, y: 13, width: 3, height: 1}

      offset_label: {class: "label", label: "Offset X/Y:", x: 0, y: 14, width: 3, height: 1}
      offset_x: {class: "floatedit", value: DEFAULTS.offset_x, config: true, x: 3, y: 14, width: 3, height: 1}
      offset_y: {class: "floatedit", value: DEFAULTS.offset_y, config: true, x: 6, y: 14, width: 3, height: 1}
      decimals_label: {class: "label", label: "Decimals:", x: 9, y: 14, width: 2, height: 1}
      decimals: {class: "intedit", value: DEFAULTS.decimals, config: true, min: 0, max: 4, x: 11, y: 14, width: 2, height: 1}
      eps_label: {class: "label", label: "Tangent eps:", x: 0, y: 15, width: 3, height: 1}
      tangent_epsilon: {class: "floatedit", value: DEFAULTS.tangent_epsilon, config: true, min: 0, x: 3, y: 15, width: 3, height: 1}

      layer_label: {class: "label", label: "Layer offset:", x: 6, y: 15, width: 3, height: 1}
      layer_offset: {class: "intedit", value: DEFAULTS.layer_offset, config: true, min: -100, max: 100, x: 9, y: 15, width: 3, height: 1}

      tags_label: {class: "label", label: "Shape tags:", x: 0, y: 16, width: 3, height: 1}
      shape_tags: {class: "edit", value: DEFAULTS.shape_tags, config: true, x: 3, y: 16, width: 8, height: 1}
    }
  }
...
show_message = (title, message) ->
  aegisub.dialog.display {
    {class: "label", label: title, x: 0, y: 0, width: 52, height: 1}
    {class: "textbox", value: tostring(message or ""), x: 0, y: 1, width: 52, height: 8}
  }, {"OK"}
...
main = (subs, sel, active) ->
  ...
  _, apply_err = apply_auto subs, sel, prepared, opts
