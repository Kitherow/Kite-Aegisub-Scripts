...
- Border-layer and color-layer generation.
...
Settings persist through ConfigHandler in `kite-obake.json`. The script includes English and Spanish interface text.
