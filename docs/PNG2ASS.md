...
PNG2ASS converts PNG images into ASS drawing lines through the `kite-png2ass` Python package.
...
- `: Kite Hotkeys :/PNG2ASS/Execute`
- `: Kite Hotkeys :/PNG2ASS/Install or Update Package`
- `: Kite Hotkeys :/PNG2ASS/Check Package`
- `: Kite Hotkeys :/PNG2ASS/Configure Package`
...
The macro can install or update the Python package from the configured source. The default package source is `git+https://github.com/Kitherow/kite-png2ass.git`.
